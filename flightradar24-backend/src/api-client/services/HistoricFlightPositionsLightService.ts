...
/* tslint:disable */
/* eslint-disable */
import type { FlightPositions } from '../models/FlightPositions';
import type { CancelablePromise } from '../core/CancelablePromise';
import { OpenAPI } from '../core/OpenAPI';
import { request as __request } from '../core/request';
export class HistoricFlightPositionsLightService {
    /**
     * Get historical flight positions with basic details
     * Returns historical information on aircraft flight movements including latitude, longitude, speed, and altitude for up to three years. At least one query parameter and a history snapshot timestamp are required to retrieve data.
     ...
     * @throws ApiError
     */
    public static getHistoricFlightPositionsLight(
        timestamp: number,
        ...
        data?: Array<FlightPositions>;
    }> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/historic/flight-positions/light',
            headers: {
